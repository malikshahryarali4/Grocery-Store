...
export const addCategoryAction = (categoryData) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.post("https://grocery-store-a5j0.onrender.com/api/category/add", categoryData);
...
export const getAllCategoryAction = () => async (dispatch) => {
  try {
    ...
    const { data } = await axios.get("https://grocery-store-a5j0.onrender.com/api/category/get");
...
export const deleteCategoryAction = (categoryId) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.delete(`https://grocery-store-a5j0.onrender.com/api/category/delete/${categoryId}`);
  ...
  (categoryId, updateFormData) => async (dispatch) => {
    try {
      ...
      const { data } = await axios.put(
        `https://grocery-store-a5j0.onrender.com/api/category/update/${categoryId}`,
        updateFormData
      );
