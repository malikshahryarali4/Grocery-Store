...
export const userRegisterAction = (userData) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.post("https://grocery-store-a5j0.onrender.com/api/user/register", userData);
...
export const userLoginAction = (userData) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.post("https://grocery-store-a5j0.onrender.com/api/user/login", userData, config);
...
export const loadUserAction = () => async (dispatch) => {
  try {
    ...
    const { data } = await axios.get("https://grocery-store-a5j0.onrender.com/api/user/getloggeduser");
    dispatch({
...
export const logOutUserAction = () => async (dispatch) => {
  try {
    ...
    const { data } = await axios.get("https://grocery-store-a5j0.onrender.com/api/user/logOut");
...
export const userPasswordUpdateAction = (userData) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.put("https://grocery-store-a5j0.onrender.com/api/user/changePassword", userData);
...
export const restPasswordSendEmailAction = (email) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.post("https://grocery-store-a5j0.onrender.com/api/user/send-reset-password-email", {
      email,
    });
  ...
  (id, token, password, confirm_password) => async (dispatch) => {
    try {
      ...
      const { data } = await axios.post(
        `https://grocery-store-a5j0.onrender.com/api/user/reset-password/${id}/${token}`,
        {
          password,
          confirm_password,
        }
...
export const getAllUsersAdminAction = () => async (dispatch) => {
  try {
    ...
    const { data } = await axios.get("https://grocery-store-a5j0.onrender.com/api/user/admin/user");
...
export const deleteUserAdminAction = (userId) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.delete(`https://grocery-store-a5j0.onrender.com/api/user/admin/user/${userId}`);
...
export const adminUpdateUserAction = (userId, UserRole) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.put(`https://grocery-store-a5j0.onrender.com/api/user/admin/user/${userId}`, {
      UserRole,
    });
