              ...
              >
                ...
                <div className="price-filter">
                  ...
                  <select onChange={(e) => setPrice(e.target.value)}>
                    ...
                    <option value="0-20">Rs. 0 - Rs. 20/Kg</option>
                    <option value="20-40">Rs. 20 - Rs. 40/Kg</option>
                    <option value="40-60">Rs. 40 - Rs. 60/Kg</option>
                    <option value="60-80">Rs. 60 - Rs. 80/Kg</option>
                    <option value="80-100">Rs. 80 - Rs. 100/Kg</option>
                    <option value="100-120">Rs. 100 - Rs. 120/Kg</option>
                  </select>
                </div>
                      ...
                      products.map((product) => {
                        return (
                          <div className="product-cart" key={product._id}>
                            ...
                            <h2>{product.name}</h2>
                            <div className="price">Rs. {product.rate}/Kg</div>
